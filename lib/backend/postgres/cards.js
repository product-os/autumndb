	...
	await Promise.all([
		Bluebird.map(
			...
			async (secondaryIndex) => {
				...
				await utils.createIndexConcurrently(context, connection, table, fullyQualifiedIndexName,
...
exports.createTypeIndex = async (context, connection, fields, type) => {
	...
	await utils.createIndexConcurrently(context, connection, CARDS_TABLE, fullyQualifiedIndexName,
...
exports.createFullTextSearchIndex = async (context, connection, type, fields) => {
	...
	for (const field of fields) {
		...
		await utils.createIndexConcurrently(context, connection, CARDS_TABLE, name,
