...
exports.setup = async (context, connection, database, options) => {
	...
	/* -- to be manually executed after all old data was fixed

		ALTER TABLE links ALTER COLUMN version_major SET NOT NULL;
		ALTER TABLE links ALTER COLUMN version_major SET DEFAULT 1;
		ALTER TABLE links ALTER COLUMN version_minor SET NOT NULL;
		ALTER TABLE links ALTER COLUMN version_minor SET DEFAULT 0;
		ALTER TABLE links ALTER COLUMN version_patch SET NOT NULL;
		ALTER TABLE links ALTER COLUMN version_patch SET DEFAULT 0;
 ...
 */
	...
	ALTER TABLE ${LINK_TABLE} DROP CONSTRAINT IF EXISTS ${LINK_TABLE}_slug_version_major_version_minor_version_patch_key;
...
exports.upsert = async (context, connection, link) => {
	if (link.active) {
		...
		} = utils.parseVersion(link.version)
