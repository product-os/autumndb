...
module.exports = class Kernel {
   ...
   */
	async patchCardBySlug (context, session, slug, patch) {
		...
		// Get card object differences before and after applying patch.
		const diff = utils.getPatchDiff(fullCard, patchedFullCard)
		...
		await this.backend.patchElement(context, patchedFullCard, diff)
