...
module.exports = class Kernel {
   ...
   */
	async stream (context, session, schema, options) {
		...
		const stream = await this.backend.stream(context, selected, filteredQuery, options)
		...
		stream.on('query', async (payload) => {
			console.log('============================')
			console.log('query stream options', payload.options)
			console.log('============================')
		...
		stream.on('setSchema', async (payload) => {
			console.log('============================')
			console.log('setSchema options')
			console.log('payload:', payload)
			console.log('newOptions:', payload.options)
			const query = await getQueryFromSchema(context, this.backend, session, payload.schema)
			console.log('query.selected:', query.selected)
			console.log('============================')
			stream.setSchema(query.selected, query.filteredQuery, payload.options)
		})
